        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<c:url value='/group'/>" class="waves-effect"><i class="fa fa-table fa-fw"
                        ...
                        <div class="white-box">
                            <form action="<c:url value='/profile-edit'/>" method="post" class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" readonly value="${job.project.name}" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Tên công việc</label>
                                    <div class="col-md-12">
                                        <input type="text" readonly value="${job.name}" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày bắt đầu</label>
                                    <div class="col-md-12">
                                        <input type="text" readonly value="${job.startDate}" class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày kết thúc</label>
                                    <div class="col-md-12">
                                        <input type="text" readonly value="${job.endDate}" class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
								    ...
								    <div class="col-md-12">
								        <select name="id_status" class="form-control form-control-line">
								            <c:forEach var="item" items="${listStatus}">
								                ...
								                <c:if test="${item.id eq job.status.id}">selected</c:if>>${item.name}						
												</option>
								            </c:forEach>
								        </select>
								    </div>
                                ...
                                <div class="form-group">
                                 ...
                                 <c:if test="${not empty isSuccess}">
	                            	<c:if test="${isSuccess}">
	                    				Sửa thành công   <p>${job.status.id}</p>
	                   				 </c:if>
				                    <c:if test="${!isSuccess}">
				                    	Sửa thất bại
				                    </c:if>
