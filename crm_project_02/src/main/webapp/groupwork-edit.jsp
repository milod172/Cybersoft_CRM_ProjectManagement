            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action="<c:url value='/group-edit' />" method="post" class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="startDate" type="text" value="${project.startDate}"
                                            class="form-control form-control-line" required> </div>
                                            <span style="color:red;">${StartErr}</span>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="endDate" type="text" value="${project.endDate}"
                                            class="form-control form-control-line" required> </div>
                                        <span style="color:red;">${EndErr} ${ErrTimeLine}</span>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-success">Lưu lại</button>
                                        <a href="<c:url value='/group'/>" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
