                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            <form class="form-horizontal form-material" action='<c:url value="/user-edit" />' method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="password" value="${user.pwd}" name="password" class="form-control form-control-line" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                        ...
                                        <select  name="role" class="form-control form-control-line">
                                            <c:forEach var="item" items="${listRole}">
                                            	 <option value="${item.id}"
                                            	  <c:if test="${item.id eq user.role.id}">selected</c:if>>${item.name}
                                            	 </option>
                                            </c:forEach>                                 
                                        </select>
                                    </div>
