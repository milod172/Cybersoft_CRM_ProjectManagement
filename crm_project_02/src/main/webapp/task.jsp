                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                    	<c:forEach var="item" items="${listJob}" varStatus="Count">    
	                                    	<c:if test="${not empty listJob}">
		                                        <tr>
		                                            ...
		                                            <td>
		                                                <a href="<c:url value='/profile-edit'/>?id_job=${item.id}" class="btn btn-sm btn-primary">Sửa</a>
		                                                <a href="#" class="btn btn-sm btn-danger btn-xoa" id-job="${item.id}" id-user="${item.user.id}">Xóa</a>
