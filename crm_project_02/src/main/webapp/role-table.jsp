                            ...
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    <thead>
	                                    ...
	                                    <tbody>
	                                    	<c:forEach var="item" items="${listRole}" varStatus="Count">    
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                                <a href="<c:url value='/role-edit'/>?id_role=${item.id}" class="btn btn-sm btn-primary">Sửa</a>
	                                                <a href="#" class="btn btn-sm btn-danger btn-xoa" id-role="${item.id}">Xóa</a>
	                                            </td>
	                                        </tr>
	                                        	 </c:if> 
	                                         </c:forEach>
