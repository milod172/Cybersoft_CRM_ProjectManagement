                        ...
                        <li>
                            <div class="dropdown">
                                <a class="profile-pic dropdown-toggle" data-toggle="dropdown" href="#"> 
                                    <img src="plugins/images/users/dung.jpg" alt="user-img" width="36"  height="36" class="img-circle" />
                        ...
                        <div class="white-box">
                            <form  action="<c:url value='/role-add' />"  method="post" class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="role-name"  type="text" placeholder="Tên quyền"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="desc" type="text" placeholder="Mô tả" class="form-control form-control-line" required />
