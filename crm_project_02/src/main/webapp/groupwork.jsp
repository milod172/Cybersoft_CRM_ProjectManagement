            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="<c:url value='/group-add'/>" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                    	<c:forEach var="item" items="${listProject}" varStatus="Count">
	                                        <c:if test="${not empty listProject}">
		                                        <tr>
		                                            ...
		                                            <td>${item.endDate}</td>
		                                            <td>
		                                                <a href="<c:url value='/group-edit'/>?id_project=${item.id}" class="btn btn-sm btn-primary">Sửa</a>
		                                                <a href="#" class="btn btn-sm btn-danger btn-xoa" id-project="${item.id}">Xóa</a>
		                                                <a href="<c:url value='/group'/>" class="btn btn-sm btn-info">Xem</a>
		                                            </td>
		                                        </tr>
		                                     </c:if>
                                        </c:forEach>
