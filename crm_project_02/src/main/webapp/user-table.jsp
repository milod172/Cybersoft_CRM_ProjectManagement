                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                    	<c:forEach var="item" items="${listUser}" varStatus="Count">    
	                                    	<c:if test="${not empty listUser}">
		                                        <tr>
		                                            ...
		                                            <td>
		                                                <a href="<c:url value='/user-edit'/>?id_user=${item.id}" class="btn btn-sm btn-primary">Sửa</a>
		                                                <a href="#" class="btn btn-sm btn-danger btn-xoa" id-user="${item.id}">Xóa</a>
		                                                <a href="<c:url value='/user'/>" class="btn btn-sm btn-info">Xem</a>
	                                            	</td>
	                                        	</tr>
	                                        </c:if> 
	                                    </c:forEach>
